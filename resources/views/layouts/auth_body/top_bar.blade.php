<div class="navbar-custom" ><!--navbar-custom-->
    <div class="container-fluid">
        <ul class="topnav-menu float-right mb-0">
        ...
        <ul class="d-flex list-unstyled topnav-menu topnav-menu-left m-0 px-2">
            <li>
            ...
            <li class="m-auto">
                <div class="my-auto ">
                    <img class="w-25 p-2" src="{{ asset('Admin/assets/images/Edesh-logo.png') }}" alt="">
                </div>
            </li>
