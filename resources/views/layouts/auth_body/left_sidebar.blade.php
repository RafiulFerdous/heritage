<div class="left-side-menu">
    <div class="h-100" data-simplebar>
        ...
        <div class="user-box text-center">
            ...
            <img src=" {{asset(Auth::user()->image) }}" alt="user-img" title="{{ Auth::User()->username }}"
                    ...
                    <div class="collapse" id="management">
                        <ul class="nav-second-level">
                            <li>
                                ...
                                <a href="{{ url('/order/table') }}">Orders</a>
                            </li>
                            <li>

                                <a href="{{ url('/order/add') }}">Single Entry</a>
                            </li>

                            <li>

                                <a href="{{ url('order/group_entry') }}">Bulk Entry</a>
                            </li>

                            <li>

                                <a href="{{ url('/order/barcodestatuschange') }}">Update Status</a>
                            </li>
...
{{--                only admin--}}
                    ...
                    <div class="collapse" id="location">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                ...
                                <a href="{{ url('admin/location/view') }}">Locations</a>
                            </li>

                            <li>

                                <a href="{{ url('admin/location/get') }}">Location Add</a>
                            </li>
                ...
                <li>
                    <a href="{{url('/tracking')}}">
                        ...
                        <span class="ml-1"> Order Tracking</span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    <a href="#merchant" data-toggle="collapse">
                    ...
                    <div class="collapse" id="merchant">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ url('/pickup_location') }}">Pickup Locations</a>
                            </li>
                            <li>
                                <a href="{{ url('/pickup_location/create') }}">Pickup Location Add</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="reports">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="/order/reports">General Report </a>
                            </li>
           ...
           <li>
                <a href="#logistics" data-toggle="collapse">
                ...
                <div class="collapse" id="logistics">
                    <ul class="nav-second-level">
                        <li>
                            <a href="{{ url('admin/logistics') }}">Logistics</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/logisticsrate') }}">Logistics Rate</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/logisticszone') }}">Logistics Zone</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/box_size') }}">Box Sizes</a>
                        </li>
                    </ul>
                </div>
            </li>
        ...
        <li>
            <a href="#status_manage" data-toggle="collapse">
                <i class="fa-solid fa-tags"></i>
                <span> Status Management </span>
                <span class="menu-arrow"></span>
            </a>
            <div class="collapse" id="status_manage">
                <ul class="nav-second-level">

                    <li>
                        <a href="{{ url('admin/status') }}">Status</a>

                    </li>
                    <li>
                        <a href="{{ url('admin/sub_status') }}">Sub Status</a>
           ...
           <li>
                ...
                <div class="collapse" id="settings">
                    <ul class="nav-second-level">
                        ...
                        <li>
                            <a href="{{ url('admin/coupon/create') }}">Coupons Add</a>
                        </li>
